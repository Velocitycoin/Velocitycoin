...
After completing windows setup then run windows command line (cmd)
  cd daemon
  Velocitycoind
You would need to create a configuration file Velocitycoin.conf in the default
wallet directory. Grant access to Velocitycoind.exe in anti-virus and firewall
...
Velocitycoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
Velocitycoind stop
Start up the new Velocitycoind (0.3.0).
